...
urlpatterns = [
    ...
    path('reservas/<int:pk>/proposta/<int:proposta_pk>/observacoes/', views.proposta_obs_update, name='proposta_obs_update'),
    path('reservas/<int:pk>/proposta/<int:proposta_pk>/aprovar/', views.proposta_aprovar, name='proposta_aprovar'),
    path('reservas/<int:pk>/proposta/<int:proposta_pk>/reprovar/', views.proposta_reprovar, name='proposta_reprovar'),
    path('reservas/<int:pk>/proposta/<int:proposta_pk>/contraproposta/', views.contraproposta_create, name='contraproposta_create'),
    path('reservas/<int:pk>/contraproposta/<int:cp_pk>/acordo/', views.contraproposta_acordo, name='contraproposta_acordo'),
    path('reservas/<int:pk>/contraproposta/<int:cp_pk>/excluir/', views.contraproposta_delete, name='contraproposta_delete'),
    path('reservas/<int:pk>/contraproposta/<int:cp_pk>/series/adicionar/', views.contraproposta_serie_add, name='contraproposta_serie_add'),
